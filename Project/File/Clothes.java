...
public interface Clothes {
    ...
    // ใช้สำหรับการกำหนดค่าค่าใช้จ่ายเพิ่มเติมที่เกี่ยวข้องกับขนาด (SizeCharges) เมื่อผู้ใช้ต้องการแก้ไขค่านี้
    ...
    // ใช้สำหรับรับค่าค่าใช้จ่ายเพิ่มเติมที่เกี่ยวข้องกับขนาด (Size Charges) ที่ถูกตั้งค่า
